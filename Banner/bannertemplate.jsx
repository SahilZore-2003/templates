...
import bannerImage from "../../../public/assets/banner-img.png"
...
const DarkLightTemplate = () => {
    ...
    const SamplePrevArrow = (props) => {
        ...
        return (
            <div onClick={onClick} className={`arrow ${className}`} >
                <AiOutlineArrowLeft class="arrows text-white bg-[#b3c1f3] dark:bg-white dark:text-black rounded-full" />
            </div>
        )
    }
    ...
    function SampleNextArrow(props) {
        ...
        return (
            <div onClick={onClick} className={`arrow ${className}`} >
                <AiOutlineArrowRight className="arrows text-white dark:bg-white dark:text-black rounded-full" />
            </div>
        )
    }
    ...
    return (
        <div
            className={`font-${currFont} ${dark && "dark bg-black"}`}
        ...
        >
            <div className="">
                ...
                <nav className="flex justify-between px-8 items-center py-4 text-base border-b-[.5px] border-gray-500">
                    <div className="flex items-center gap-8">
                        <section className="flex items-center gap-4">
                            ...
                            <Link href={"/"} className="text-4xl font-mono">
                                <h1 className="text-xl xs:text-2xl text-prime">Bridge <span className="text-[#5172ff] uppercase">Yu</span> </h1>
                            </Link>
                        </section>
                        <div className=" flex items-center justify-between gap-4 group">
                            {navlinks.map((d, i) => (
                                <Link
                                    key={i}
                                    className="hidden lg:block text-prime group-hover:text-prime hover:!text-prime  dark:group-hover:text-white/60 dark:hover:!text-white"
                                    href={d.link}
                                >
                                    {d.label}
                                </Link>
                    ...
                    <div className="hidden lg:flex items-center gap-2 grow border-black dark:border-white border-[1px] rounded-full overflow-hidden px-4 py-2 mx-8 max-w-[400px]">
                        <IoSearchOutline className="dark:text-white" />
                        <input type="text" name="" id="" placeholder="Search Here" className="grow text-black dark:text-white  placeholder:text-black border-none outline-none bg-transparent dark:placeholder:text-white" />
                    </div>
                    ...
                    <section className="flex items-center gap-4">
                        ...
                        <button className=" bg-tertiary dark:bg-white text-sm text-white dark:text-black px-2 sm:px-5 py-2 rounded-full  border-[1px]">Sign Up</button>
                    </section>
                </nav>
                ...
                <div className="md:my-4 relative">
                    ...
                    <div className="absolute top-1/2 left-[3%] text-white bg-[#b3c1f3] p-2 rounded-sm shadow-sm shadow-black/20 cursor-pointer hidden md:block" onClick={() => sliderRef.slickPrev()}>
                        <AiOutlineArrowLeft size={20} />
                    </div>

                    <div className="absolute top-1/2 right-[3%] text-white bg-[#b3c1f3] p-2 rounded-sm shadow-sm shadow-black cursor-pointer hidden md:block" onClick={() => sliderRef.slickNext()}>
                ...
                {featured?.contentTitle != null && (
                    <div className=" mx-8 text-prime py-8 mt-16 relative flex flex-col-reverse md:flex-row justify-between md:px-8  items-center gap-8 rounded-3xl">
                        <div className="basis-[40%]">
                            <h1 className="text-xl font-medium uppercase w-fit text-black dark:text-white relative before:absolute  before:-bottom-[10%] before:w-full before:h-[2px] before:bg-gray-800 dark:before:bg-white">Our Best Course</h1>
                            <div className="mt-8">
                                <div className="flex space-x-2 font-bold">
                                    <StarRating rating={featured.rating} />
                                    <p>{featured.rating}</p>
                                    <p className="text-[#b3c1f3]">({featured.reviews.length} reviews)</p>

                                </div>
                                <h2 className=" text-2xl font-semibold mt-2">{featured.contentTitle}</h2>
                                <div dangerouslySetInnerHTML={{ __html: setHtmlWithStyle(featured.description.substring(0, 100) + "...", "text-gray-600 mt-2") }}>
                                </div>
                                <div className="mt-4">
                                ...
                                <Link onClick={() => {
                                    ...
                                    to={`/${currSite.toLowerCase()}/${featured._id}`} className="py-2 px-4 mt-4 bg-[#b3c1f3] inline-block text-white rounded-md">Enroll Now</Link>
                            </div>
                        </div>
                ...
                <div className="mt-16 mx-8 mb-8">
                    <div className="flex gap-2 items-center">
                        <div className="flex grow gap-2 overflow-x-scroll scrollbar-hidden scroll-smooth" id="tab-container">
                            <span className={clsx("border-[2px] border-black dark:border-white text-prime dark:text-white inline-block px-4 py-1 rounded-full shrink-0 cursor-pointer", activeTab === "all" && "bg-tertiary text-white dark:bg-white dark:!text-black")} onClick={() => setActiveTab("all")}>
                                All
                            </span>
                            {
                                business?.content?.map((item, index) => (
                                    <span key={index} className={clsx(" text-black border-[2px] border-black dark:border-white dark:text-white inline-block px-4 py-1 rounded-full shrink-0 cursor-pointer last:mr-12", activeTab == item.category.toLowerCase() && "bg-tertiary text-white dark:bg-white dark:!text-black")} onClick={() => setActiveTab(item.category.toLowerCase())}>
                                        {item.category}
                                    </span>
                                ))
                            }
                                ...
                                activeTab === "all" ? business?.content.map((item, i) => {
                                    return (
                                        <Link
                                            ...
                                            key={i}
                                            className="rounded-2xl bg-secondary overflow-hidden dark:bg-[#202020] dark:text-white"
                                            ...
                                            <div className="p-4">
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-4 text-xl font-semibold">
                                                        ...
                                                        <div className="text-[#8b8a8a]">({item.reviews.length})</div>
                                                    </div>
                                    ...
                                    return (
                                        <Link
                                            ...
                                            to={`/${currSite.toLowerCase()}/${item._id}`}
                                            key={i}
                                            className="rounded-2xl bg-[#d9d9d9] overflow-hidden"
                                            style={{ boxShadow: "rgba(0, 0, 0, 1) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px" }}
                                        >
                                            <div className="w-full rounded-lg">
                                                <img
                            ...
                            <Slider arrows={false} beforeChange={(_, current) => setActiveSlide(current)} asNavFor={nav1} ref={slider => (featuredRef1 = slider)}>
                                {
                                    featuredSectionData.map((item, index) => (
                                        <div>
                                            <h1 className="text-2xl font-bold dark:text-white">Fun Moments.</h1>
                                            <p className="mt-2 text-gray-800 text-xl dark:text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab eveniet in adipisci aspernatur quasi maxime quam veritatis, ratione amet quae?</p>
                            ...
                            <div className="flex items-center justify-center gap-4 mt-8 absolute md:bottom-[5%] bottom-0 w-full z-10">
                                {
                                    featuredSectionData.map((item, index) => (
                                        ...
                                        <div onClick={() => featuredRef.slickGoTo(index)} className={`relative cursor-pointer border-2  p-1 rounded-sm ${activeSlide === index ? "border-tertiary dark:border-white" : "border-white dark:border-black"}`}>
                ...
                <div className="my-8 py-12 px-4 text-white bg-black/95 relative overflow-hidden">
                    <div className="flex flex-col items-center gap-4 max-w-[800px] text-center mx-auto px-4 relative z-[100]">
                        ...
                        <button className="px-4 mt-4 transition-all duration-300 rounded-sm py-2 border-white/60 border-[1.5px] hover:-translate-y-[10%]">Learn More</button>
                    </div>
                ...
                <div className="mx-8 my-12 md:mb-16 dark:text-white">
                    <div className="">
                        <h1 className="font-bold text-2xl">FAQ</h1>
                        <p className="my-4 italic text-xl sm:w-1/2">Sample text. Click to select the text box. Click again or double click to start editing the text.</p>
                    </div>
                    <div className="flex flex-col gap-8 my-8 md:flex-row items-start md:justify-around">
                        <div className="my-4 overflow-hidden md:basis-[45%]">
                            {
                                faq.map((item, index) => (
                                    <div key={index} className="border-b-[.5px] border-black dark:border-white py-4 mt-2">
                                        ...
                                        <Collapse isOpened={item.show}>
                                            <div className={`mt-4 text-lg  transition-all duration-500 delay-300`}>
                                                {item.answer}
                                            </div>
                                        </Collapse>
                                    </div>
                ...
                <div className="my-8 px-8  dark:bg-[#212121] dark:text-white py-4 md:flex gap-8">
                    ...
                    <div className="flex flex-col my-8 sm:flex-row gap-4 md:my-12 lg:my-16 bg-[#f2f2f2] py-12 px-8 flex-wrap sm:gap-y-8 sm:text-center sm:justify-between md:basis-[60%] rounded-md" style={{ boxShadow: "rgba(0, 0, 0, 0.16) 0px 1px 4px" }}>
                        {
                            counterData.map((item, index) => (
                                <div key={index} className={`sm:basis-[40%]`}>
                                    <h1 className="font-bold text-6xl dark:text-black"><Counter end={item.count} suffix={"+"} /></h1>
                                    <p className="text-2xl mt-4 text-[#bbc5cb] dark:text-black">{item.title}</p>
                                </div>
                            ))
                        }
                    </div>
                ...
                <InView triggerOnce={true} threshold={.5}>
                    {
                        ({ ref, inView }) => (
                            <div ref={ref} className="my-8 py-8 lg:py-12 px-4 bg-gradient-to-r from-[#b3c1f3] to-[#ebeffc] flex flex-col sm:flex-row sm:flex-wrap sm:justify-around gap-8">
                                {
                                    testimonials.map((item, index) => (

                                        <div key={index} className={`bg-white rounded-sm p-4 relative sm:basis-[45%] transition-all duration-1000 lg:basis-[30%] ${inView ? "-translate-y-[10%]" : "translate-y-[0%]"}`}>
                                            <div className="">
                                            ...
                                            <BiSolidQuoteAltRight size={50} className="fill-[#aabaf7] opacity-50 absolute right-[10%] top-[5%]" />
                                        </div>
                ...
                <div className="bg-tertiary text-prime dark:bg-black dark:text-white w-full py-10 px-14 mt-20">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:grid-cols-5">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2 mt-4">
                                {
                                    items.map((e, i) => (
                                        <div key={i} className="bg-[#4e4a4aaa] p-2 rounded-full">
                                ...
                                return (
                                    <div key={i}>
                                        ...
                                        <div className="mt-2">
                                            {
                                                e.items.map((e, i) => (
                                                    <a key={i} className="block text-[black] dark:text-white" href="">{e}</a>
                                                ))
                                            }
                                        </div>
                                    </div>
                    ...
                    <div className="mt-6 border-t-[1px] border-[black] dark:border-white pt-4">
                        <p className="text-center text-black dark:text-white font-bold">copyright ©️ Bridge YU</p>
                    </div>
                </div>

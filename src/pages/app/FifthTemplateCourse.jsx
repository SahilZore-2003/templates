...
const FifthTemplateCourse = () => {
    ...
    return (
        ...
        >
            ...
            <div className="relative md:px-14 bg-white text-black md:bg-gradient-to-tr from-[#270a37] from-33% via-[#120522] via-47% to-[#46063c] to-79% md:text-white">
                ...
                <div className="bg-white text-black rounded-lg my-6 hidden md:block md:absolute top-0 right-[5%] md:w-[30%] [box-shadow:#3c40434d_0px_1px_2px_0px,#3c404326_0px_2px_6px_2px]" id="course-card">
                    ...
                    <div className="px-4">
                        ...
                        <div className="text-center">
                            <button className="w-full bg-[#210618]  py-2 text-white my-4 sm:w-1/2 mx-auto md:w-full">Buy Now</button>
                        </div>
            ...
            <div id="main-course-container">
                ...
                {/* what you will learn  */}
                <div className="m-6 md:m-14 bg-gradient-to-r from-[#02030a]  via-[#220618] to-[#0f000d] text-white p-4 md:w-1/2 border-[1px] border-black/40 rounded-lg">
                        ...
                        >
                            {
                                convertStringToArray(content.perks).slice(0, expandedPerks ? convertStringToArray(content.perks).length : 4).map((e, i) => (
                                    <div className="flex gap-2 mt-4" key={i}>
                                        <IoCheckmark size={20} className="shrink-0 mt-2 text-white" />
                                        {e}
                                    </div>
                                ))
                            }
...

                    {
                        convertStringToArray(content.perks).length > 4 && (
                            <button
                                ...
                                className={`transition-all duration-150 mt-4 text-white font-bold text-sm flex items-center gap-2`}
                            >

                                {expandedPerks ? "See Less" : "See More"}
                                <IoChevronDown size={20} className={`transition-transform duration-300 mx-auto text-white  ${expandedPerks ? "rotate-180" : "rotate-0"}`} />
                            </button>
                        )
                ...
                <div className="md:w-1/2 m-6 md:m-14">
                    <span className="font-bold text-2xl text-[#210618]">Course Content</span>
                    <Accordion
                        type="single"
                        collapsible
                        ...
                        {content.sections.map((item, id) => (
                            <div key={item._id}>
                                <AccordionItem value={item._id}>
                                    <AccordionTrigger className="bg-[#210618] text-white px-4">
                                                ...
                                                >
                                                    {material.type === "video" ? (
                                                        <div className="flex flex-row items-center space-x-4">
                                                            ...
                                                            <Dialog>
                                                                <DialogTrigger>
                                                                    <a className="text-xs hover:text-primary text-black">
                                                        ...
                                                        <div className="flex flex-row items-center space-x-4">
                                                            ...
                                                            />
                                                            <Link
                                                                className="text-xs hover:text-primary text-black"
                                                                onClick={
                                                                    () => { }
                                                        ...
                                                        <div className="flex flex-row items-center space-x-4">
                                                            ...
                                                            <Dialog>
                                                                <DialogTrigger>
                                                                    <a className="text-xs text-black hover:text-primary">
                                                                        {material.title}&emsp;&emsp;
                                                                    </a>
                                                                </DialogTrigger>
                                                                <DialogContent>
                ...
                <div className="m-6 md:m-14 rounded-lg bg-white p-4 md:w-1/2" ref={descriptionBox}>
                    <span className="font-bold text-2xl text-[#210618]">Description</span>
                    <Collapse isOpened={true}>
                        <article
...

                        {
                            <button
                                ...
                                className={`transition-all duration-150 mt-4 text-[#210618] font-bold text-sm flex items-center gap-2`}
                            >

                                {expandedDescription ? "See Less" : "See More"}
                                <IoChevronDown size={20} className={`transition-transform duration-300 mx-auto text-[#210618] ${expandedDescription ? "rotate-180" : "rotate-0"}`} />
                            </button>
                        }
                    </Collapse>
                ...
                <div className="m-6 md:m-14 rounded-lg p-4 md:w-1/2">
                    <span className="text-2xl text-[#210618] font-bold">prerequisites</span>
                    <article
                        className="prose"
                    >
                        <ul
                ...
                <div className="m-6 md:m-14 rounded-lg  p-4 md:w-1/2">
                    <span className="text-2xl text-[#210618] font-bold">
                        Who this course is for
                    </span>
                    <article
                        className="prose"
                    >
                        <Collapse isOpened={true}>
                            <div
                                className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-4 rounded-xl p-4 bg-[#1d0415] mt-4"
                            >
                                {
                                    convertStringToArray(content.whoFor).slice(0, expandedWhoFor ? convertStringToArray(content.whoFor).length : 4).map((e, i) => (
                                        <div key={i} className={`transition-all text-white duration-300 text-sm  grid  ${i > 3 && !setExpandedWhoFor ? "grid-rows-[0fr]" : "grid-rows-1 py-3"}`}>
                    ...
                    </article>
                    {
                        convertStringToArray(content.whoFor).length > 4 && (
                            <button
                                ...
                                className={`transition-all duration-150 mt-4 text-[#210618] font-bold text-sm flex items-center w-full gap-2`}
                            >

                                {/* {expandedWhoFor ? "See Less" : "See More"} */}
                                <IoChevronDown size={30} className={`transition-transform duration-300 mx-auto text-[#210618]   ${expandedWhoFor ? "rotate-180" : "rotate-0"}`} />
                            </button>
                        )
                ...
                <div className="m-6 md:m-14  p-4 md:w-1/2 text-xs font-medium">
                    <span className="font-bold text-2xl text-[#210618]">Instructor</span>
...

                {
                    content.reviews.length > 0 && <div className="m-6 md:m-14  p-4 md:w-1/2 text-xs font-medium">
                        <h1 className="text-2xl font-bold text-[#02030a]">Our Success Stories.</h1>
                        <div className="mt-8 grid md:grid-cols-2 grid-cols-1 bg-[#02030a] text-white rounded-lg overflow-hidden border-[1px] border-[#202329]">
                            {
                                content.reviews.map((item, index) => (
                                    <div key={index} className="p-4 border-[1px] border-[#202329]">
                                        <div className="flex gap-2 items-center">
                                            <img className="object-cover w-12 h-12 rounded-full" src={item.profile} alt="" />
                                            <div className="grow">
                                                <h2 className="text-lg">{item.name}</h2>
                                                <p className="text-white/50">{item.qualification}</p>
                                            </div>
                                        </div>
            ...
            <div className={`md:w-1/3 bg-gradient-to-r from-[#02030a]  via-[#220618] to-[#0f000d] my-8 mx-8 rounded-lg md:my-0 md:mx-0  p-4 text-white md:fixed right-[5%] top-[10%] z-30 transition-all duration-200 ${showPurchaseContainer ? "opacity-100" : "opacity-0"}`}>
                ...
                <button
                    onClick={() => { }}
                    className="bg-white w-full text-black font-semibold text-md p-3 rounded-lg uppercase hover:opacity-95 disabled:opacity-80"
                >
                    Add to cart
                </button>
            </div>
            ...
            <footer className="bg-gradient-to-r from-[#02030a]  via-[#220618] to-[#0f000d] text-white pt-8 px-4">

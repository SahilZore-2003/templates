...
const HomePage = () => {
    ...
    return (
        ...
        <div
            ...
            data-theme={`${business?.styles?.uiMode}`}
            id={business?.theme}
        // ref={nahiHoRhaTheme}
        >
                            ...
                            <div className="mt-8 md:mt-0 md:w-1/2 md:ml-8 flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4 items-center">
                                        <button className=" rounded-md text-base font-medium px-4 py-1" style={{ background: primary, color: innerText }}>Buy Now</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        Array.from({ length: 3 }).map((item, index) => (
                            business?.dataSlate[`value${index + 1}`] ?
                                <div key={index} className="w-[100%] sm:w-[45%] lg:w-[30%] flex flex-col items-center gap-4 rounded-lg mt-8" >
                                    ...
                                    <h1 className="text-center uppercase font-bold">{business?.dataSlate[`dataName${index + 1}`]}</h1>
                                </div> : null
                        ))
                    }

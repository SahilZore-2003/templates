...
import h1 from "../../../public/assets/t-5/h1.jpg"
import h2 from "../../../public/assets/t-5/h2.jpg"
import h3 from "../../../public/assets/t-5/h3.jpg"
import headerImage1 from "../../../public/assets/t-5/12.png"
import headerImage2 from "../../../public/assets/t-5/10.png"
import headerImage3 from "../../../public/assets/t-5/14.png"
...
const HomePage = () => {
    ...
    const featuredSectionData = [
        {
            ...
            description:
                '<h1 class="text-white text-center font-bold text-4xl">Use essential <span class=" font-semibold">skill</span> tool</h1><div class="flex items-start flex-col mt-4 gap-4" ><p class="grow text-white text-center text-sm sm:text-lg">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Rerum, reprehenderit?</p><button class="bg-white rounded-xl md:mt-4 py-2 px-4 whitespace-nowrap font-bold mx-auto">Apply Now</button></div > ',
        },
        {
    ...
    return (
        <div
            className={`font-${currFont}`}
            style={inlineStyle}
            data-theme={`${currTheme}`}
        // ref={nahiHoRhaTheme}
        >
            {/* home banner section  */}
            <div className="bg-gradient-to-r from-gradient-first from-30% via-gradient-second 70% to-gradient-third to-90% pb-12">

                <nav className="flex justify-between px-8 items-center py-6 text-white">
                    <div className="flex items-center gap-8">
                        <section className="flex items-center gap-4">
                            ...
                            <Link href={"/"} className="text-4xl font-mono">
                                <h1 className="text-2xl text-white">Bridge <span className="text-[#5172ff] uppercase">Yu</span> </h1>
                            </Link>
                        </section>
                        {navlinks.map((d, i) => (
                            <Link
                                key={i}
                                className="hidden lg:block  text-white hover:font-bold"
                                href={d.link}
                            >
                                {d.label}
                            </Link>
                    ...
                    <section className="flex items-center gap-4">
                        {/* cart icon */}
                        <button className="bg-transparent text-white px-5 py-2 rounded-full  border-white border-[1px]">Apply Now</button>
                    </section>
                </nav>
                <hr className=" " />
                ...
                <div className="py-4 px-8  md:grid grid-cols-4 gap-4">
                    <div className="text-white py-8 md:col-span-2 md:place-content-center">
                        <h1 className="text-5xl mb-4">Best Education Material</h1>
                        <p className="text-xl">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Saepe voluptatum dolorem esse quo? Cumque, assumenda ex! Quia cupiditate culpa iste ducimus sequi quod harum similique, cumque quis molestiae facilis optio.</p>
                        <button className="text-2xl bg-primary mt-4 px-4 py-2 rounded-full">Apply Now</button>
                    </div>
            ...
            {featured?.contentTitle != null && (
                <div className="mx-4 md:flex items-center justify-between bg-white  overflow-hidden my-8  md:my-12 md:mx-8">
                    ...
                    <div className="my-8 mx-4  md:basis-[50%]">
                        <span className="font-bold text-black rounded-2xl text-xl">{featured.category}</span>
                        <h1 className="font-bold text-2xl mt-4">{featured.contentTitle}</h1>
                        <div dangerouslySetInnerHTML={{
                            __html: setHtmlWithStyle(featured.description.substring(0, 100) + "...", "mt-4 text-xl")
                        }}>
                        </div>
                        ...
                        <Link className="flex gap-4 rounded-full font-bold px-4 py-2 w-fit mt-6 items-center group text-white bg-[#08040d]"
                            onClick={() => {
                            ...
                            {business?.content.map((item, index) => {
                                return (
                                    <Link className="mt-8 rounded-md overflow-hidden relative min-h-[320px]" key={index} onClick={() => {
                                        ...
                                        <div className="overlay absolute inset-0 bg-gradient-to-b from-transparent from-20% to-secondary to-60% z-0">
            ...
            <div className=" bg-gradient-to-r from-primary  via-secondary to-primary flex flex-col items-center text-white p-4 py-8 gap-8 mt-8 md:flex-row md:justify-around md:py-16 md:px-8 ">
            ...
            <div className="my-12 bg-gradient-to-r from-gradient-first from-30% via-gradient-second 60% to-gradient-third to-80%  py-4">
                ...
                <Marquee pauseOnHover={true} play={true} className="mt-8 md:my-12">
                    {
                        testimonials.map((item, index) => (
                            <div key={index} className="text-white bg-gradient-to-r from-primary via-secondary to-primary rounded-xl p-4 w-[300px] mx-4" >
            ...
            <div className="w-full relative grid place-content-center py-8" style={{
                ...
                <div className="relative text-center flex flex-col items-center gap-8 text-white max-w-[768px] px-4 md:px-0">
                    ...
                    <Link className="py-2 px-4 rounded-md bg-white text-black grow-0 w-fit">Get Started</Link>
                </div>
            </div>

            {/* Faq section  */}

            <div className="my-12 max-w-[800px] mx-4 [@media(min-width:800px)]:mx-auto">
                            ...
                            <div className="flex items-center gap-4 my-8">
                                <div className="grow border-b-[.5px] border-[#11010e]">
                                    ...
                                    <Collapse isOpened={selectedFaq === index}>
                                        <p className="mt-4 text-xl pb-2">{item.answer}</p>
                                    </Collapse>
                                </div>
                                <div>
                                    <span onClick={() => setSelectedfaq(selectedFaq === index ? false : index)} className={`rounded-full p-2 inline-block border-[1px] border-primary overflow-hidden cursor-pointer relative ${selectedFaq === index ? "bg-primary" : "bg-white"} `}>
                                        <FaMinus size={20} className={`${selectedFaq === index ? "fill-white" : "fill-primary"}`} />
                                        <FaMinus size={20} className={`fill-primary rotate-90 absolute  left-[20%]  ${selectedFaq === index ? "-top-[100%]" : "top-[22%]"}`} />
                                    </span>
                                </div>
                            </div>
                        ))
            ...
            <footer className="bg-gradient-to-r from-primary  via-secondary to-primary text-white pt-8 px-4">
                <div className="lg:grid grid-cols-3 lg:border-b-[1px]">
                    <div className="lg:pb-4">
                        ...
                        <div class="relative mt-6 border-white border-[1px] rounded-3xl">
                            ...
                            <label for="floating_outlined" class="absolute text-sm text-white bg-[#02021e]  duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0]  px-2 peer-focus:px-2 peer-focus:text-white  peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Your Email address.</label>
                    ...
                    <div className="mt-6 lg:mt-2 lg:text-center">
                        <p className="text-sm text-[#90909d] uppercase pb-2">Drop Us a Line</p>
                ...
                <div className="text-[#90909d] text-center py-4">
